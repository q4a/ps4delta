...
// 5.9.9 - https://download.qt.io/online/qtsdkrepository/windows_x86/desktop/qt5_599/Updates.xml
//   MSVC 2015 32-bit
//   MSVC 2017 64-bit
//   MinGW 5.3.0 32-bit
...
var PREVIOUS_COMPONENTS = [
    ...
    // 5.9.9
    "qt.qt5.599.win32_mingw53",
    "qt.qt5.599.win32_msvc2015",
    "qt.qt5.599.win64_msvc2017_64",
    "qt.qt5.599.qtcharts",
    "qt.qt5.599.qtcharts.win32_mingw53",
    "qt.qt5.599.qtcharts.win32_msvc2015",
    "qt.qt5.599.qtcharts.win64_msvc2017_64",
    "qt.qt5.599.qtdatavis3d",
    "qt.qt5.599.qtdatavis3d.win32_mingw53",
    "qt.qt5.599.qtdatavis3d.win32_msvc2015",
    "qt.qt5.599.qtdatavis3d.win64_msvc2017_64",
    "qt.qt5.599.qtnetworkauth",
    "qt.qt5.599.qtnetworkauth.win32_mingw53",
    "qt.qt5.599.qtnetworkauth.win32_msvc2015",
    "qt.qt5.599.qtnetworkauth.win64_msvc2017_64",
    "qt.qt5.599.qtpurchasing",
    "qt.qt5.599.qtpurchasing.win32_mingw53",
    "qt.qt5.599.qtpurchasing.win32_msvc2015",
    "qt.qt5.599.qtpurchasing.win64_msvc2017_64",
    "qt.qt5.599.qtremoteobjects",
    "qt.qt5.599.qtremoteobjects.win32_mingw53",
    "qt.qt5.599.qtremoteobjects.win32_msvc2015",
    "qt.qt5.599.qtremoteobjects.win64_msvc2017_64",
    "qt.qt5.599.qtscript",
    "qt.qt5.599.qtscript.win32_mingw53",
    "qt.qt5.599.qtscript.win32_msvc2015",
    "qt.qt5.599.qtscript.win64_msvc2017_64",
    "qt.qt5.599.qtspeech",
    "qt.qt5.599.qtspeech.win32_mingw53",
    "qt.qt5.599.qtspeech.win32_msvc2015",
    "qt.qt5.599.qtspeech.win64_msvc2017_64",
    "qt.qt5.599.qtvirtualkeyboard",
    "qt.qt5.599.qtvirtualkeyboard.win32_mingw53",
    "qt.qt5.599.qtvirtualkeyboard.win32_msvc2015",
    "qt.qt5.599.qtvirtualkeyboard.win64_msvc2017_64",
    "qt.qt5.599.qtwebengine",
    "qt.qt5.599.qtwebengine.win32_msvc2015",
    "qt.qt5.599.qtwebengine.win64_msvc2017_64",
...
// PS4DELTA+
// Source of this file: https://github.com/appveyor/build-images/blob/cfe87c4872c01bb11f15b40d0b155a2ea716d8cf/scripts/Windows/install_qt.qs

// I want to have minimal changes with original, so few lines addon looks best choice

// 5.14.1 - https://download.qt.io/online/qtsdkrepository/linux_x64/desktop/qt5_5141/Updates.xml
//   GCC 64-bit
var PS4DELTA_LINUX_COMPONENTS = [
    "qt.qt5.5141.gcc_64"
];
INSTALL_COMPONENTS = PS4DELTA_LINUX_COMPONENTS;
